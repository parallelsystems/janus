...
struct janus_ice_peerconnection_medium {
	...
	/*! \brief Last received keyframe's sequence numbers (as a support to NACK generation, for each simulcast SSRC), incremented by 1. 0 means never received a keyframe */
	guint32 last_kf_seqs[3];
